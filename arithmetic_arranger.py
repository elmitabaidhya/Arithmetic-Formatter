def arithmetic_arranger(arithmetic_problems, val=False):
  arranged_problems = ''
  ...
  operations = list(map(lambda x: x.split()[1], arithmetic_problems))
  ...
  top_row = ''
  dashes = ''
  values = list(map(lambda x: eval(x), arithmetic_problems))
  solutions = ''
